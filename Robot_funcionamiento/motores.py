...
class Motores:
    def __init__(self):
        ...
        self.Motor_A1 = Pin(13, Pin.OUT, value=0)
        self.Motor_A2 = Pin(12, Pin.OUT, value=0)
        self.Motor_B1 = Pin(27, Pin.OUT, value=0)
        self.Motor_B2 = Pin(14, Pin.OUT, value=0)
    ...
    def mover_ruedas(self, velocidad_izquierda, velocidad_derecha):
        ...
        self.Motor_A1.duty(velocidad_derecha)
        self.Motor_A2.duty(0)
        self.Motor_B1.duty(0)
        self.Motor_B2.duty(velocidad_izquierda)
        self.estado_actual = "andando"
