...
SSID = "Awifitesting"
PASSWORD = "whateverittakes"

# --- Configuración MQTT ---
BROKER = "192.168.48.31" # IP del broker MQTT (Raspberry Pi)
PORT = 1883
...
ROBOT_ID = "robot2" # Cambia en cada ESP32
...
def moverse_a_celda(destino):
    ...
    if destino_y != actual_y:
        ...
        while True:
            ...
            if abs(distancia_frontal - distancia_objetivo) <= 3: # margen de error
                break
            time.sleep_ms(20)
        motores.detener_motores()
